...
-- Sat 23 May 2015 06:48:48 PM CST
...
-- -----------------------------------------------------
-- Table `web_course`.`AuthItem`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `web_course`.`AuthItem` (
  `id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` VARCHAR(64) NOT NULL COMMENT '角色名或者操作名',
  `description` TEXT NOT NULL COMMENT '具体描述一个角色或者操作',
  `type` INT(11) NOT NULL COMMENT '对应每种操作给一个数字，便于后面的查询和匹对',
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COMMENT = 'name定义角色和操作, \n';
...
-- -----------------------------------------------------
-- Table `web_course`.`AuthItem_child`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `web_course`.`AuthItem_child` (
  `parent` INT(11) NOT NULL,
  `child` INT(11) NOT NULL,
  PRIMARY KEY (`parent`, `child`),
  INDEX `name_idx` (`child` ASC),
  CONSTRAINT `id`
    FOREIGN KEY (`parent`)
    REFERENCES `web_course`.`AuthItem` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `name`
    FOREIGN KEY (`child`)
...
CREATE TABLE IF NOT EXISTS `web_course`.`Team_user_role` (
  ...
  CONSTRAINT `parent`
    FOREIGN KEY (`role`)
    REFERENCES `web_course`.`AuthItem_child` (`parent`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `id`
    FOREIGN KEY (`user_id`)
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_team_user_role_1`
    FOREIGN KEY (`team_id`)
